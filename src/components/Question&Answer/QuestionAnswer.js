...
const QuestionAnswer = () => {
    return (
        <div>
            ...
            <div>
                <h3>What is the work of useEffect without data load?</h3>
                <p>By using this Hook, you tell React that your component needs to do something <br /> after render. React will remember the function you passed (we'll refer to it as our “effect”), and call it later after performing the DOM updates.</p>
            </div>
        </div>
    );
};
